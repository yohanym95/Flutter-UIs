...
class SubmitDesignPaid extends StatefulWidget {
  @override
  _SubmitDesignPaidState createState() => _SubmitDesignPaidState();
}

class _SubmitDesignPaidState extends State<SubmitDesignPaid> {
  String _chosenValue;
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 10, right: 10),
                    child: Text(
                      'You can upload a sketch or something if you have one.',
                      textAlign: TextAlign.center,
                      style: GoogleFonts.montserrat(
                        fontStyle: FontStyle.normal,
                        fontSize: 10,
